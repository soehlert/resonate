"""Last.fm metadata provider implementing BaseMetadataProvider."""
...
class LastFmProvider(BaseMetadataProvider):
    """Fetch tags from Last.fm API with web scraping fallback."""
    ...
    def fetch_track_tags(
        ...
        if uncensored and uncensored.lower() != title.lower():
            title_variants.append(uncensored)
